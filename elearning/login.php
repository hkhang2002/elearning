  ...
  <div class="limiter">
    <div class="container-login100">
      ...
      <div class="wrap-login100">
        <div class="title">
          <h1 style=" margin-left:150px; padding-bottom: 100px; color: red;">HỆ THỐNG HỌC KẾT HỢP</h1>
        </div>
        <div class="login100-pic js-tilt" data-tilt style="background: white;">
          <img src="images/langmaster.png" style="width: 100%;object-fit: contain;height: 100%" alt="IMG">
        </div>
